...
- 🇨🇳 简体中文 — [privacy-policy.zh-Hans.md](./privacy-policy.zh-Hans.md)

## 💬 Support / 技术支持

- 🇬🇧 English — [support.en.md](./support.en.md)
- 🇨🇳 简体中文 — [support.zh-Hans.md](./support.zh-Hans.md)
...
- **No third-party SDKs.** No analytics, no advertising, no tracking.
- **Purchases handled by Apple.** All in-app purchases are one-time, non-consumable unlocks (never a subscription) processed by Apple. We never see your payment information.
